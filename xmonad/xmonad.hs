...
-- Custom lock screen
myLock = "betterlockscreen -l dim -t 'Need More TOPs? Unlock Me!'"
...
--
myWorkspaces = ["1:mgmt","2:chrome","3:hw","4:sw","5:other","6:vm","7:doc", "8:zoom", "9-misc"] ++ map show [6..9]
