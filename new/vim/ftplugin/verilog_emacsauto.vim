...
if !hasmapto('<Plug>VerilogEmacsAutoAdd')
   map <unique> <Leader>e <Plug>VerilogEmacsAutoAdd
   "map <unique> <C-N> <Plug>VerilogEmacsAutoAdd
endif
if !hasmapto('<Plug>VerilogEmacsAutoDelete')
   map <unique> <Leader>f <Plug>VerilogEmacsAutoDelete
   "map <unique> <C-M> <Plug>VerilogEmacsAutoDelete
endif
